---
name: resume-builder
description: Generate professional resumes that conform to the rbuilder schema. Use when the user wants to create, build, or generate a resume through conversational AI, or asks about resume structure, sections, or content. This skill guides the agent to ask clarifying questions, avoid hallucination, and produce valid JSON output for https://rxresu.me.
---

# Resume Builder for rbuilder

Build professional resumes through conversational AI for [rbuilder](https://rxresu.me), a free and open-source resume builder.
...
rbuilder MCP can manage job applications as well as resumes. When the user wants to track applications through an agent, use the application tools instead of asking them to open the web UI.
...
Output must conform to the rbuilder schema. See [references/schema.md](references/schema.md) for the complete schema structure.
...
When generating the resume, output a complete JSON object that conforms to the rbuilder schema. The user can then import this JSON directly into rbuilder at https://rxresu.me.
